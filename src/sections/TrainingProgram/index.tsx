...
const trainiers = [
  {
    title: "Пробная бесплатная тренировка",
    description:
  ...
  },
  {
    title: "Похудение",
    description:
      "Эффективная программа тренировок и питания для коррекции массы тела, устранения «проблемных зон», формирования эстетики и легкости. Все это — в удобном онлайн-формате с постоянной поддержкой и индивидуальным подходом!",
  },
  {
    title: "Набор массы",
    description:
      "Программа для тех, кто хочет увеличить мышечную массу и создать сильное, подтянутое тело. Индивидуальные тренировки и питание, разработанные с учетом вашего уровня подготовки и целей, помогут достичь результата в удобном онлайн-формате!",
  },
  {
  ...
  },
  {
    ...
    description:
      "Тренируйтесь там, где вам удобно! Индивидуальные программы тренировок для фитнес-зала и дома. Эффективные упражнения с учётом ваших целей, наличия оборудования и уровня подготовки.",
  },
];
